...
while True:
    ...
    # print('--- Llevamos '+str(sum(tokens_mensaje))+' tokens de '+str(ventana)+'. La respuesta máxima es '+str(max_respuesta)+' ---')
    # for i in range(len(mensajes)):
    #     print(mensajes[i]['role']+' - '+mensajes[i]['content'][:10] + ' - ' + str(tokens_mensaje[i]))
